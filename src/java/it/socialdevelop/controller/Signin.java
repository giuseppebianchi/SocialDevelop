 ...
 * @version
 */
public class Signin extends SocialDevelopBaseController {
    ...
    private void action_signin(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException, TemplateManagerException, DataLayerException, SQLException, NamingException {
        ...
        String u = (String) s.getAttribute("previous_url");
            ...
            res.activate("signin.ftl.html", data, response);
